 ...
 */
static __inline int setenv_addr(const char *varname, const void *addr)
{
...
/* $(CPU)/cpu.c */
static __inline int cpumask_next(int cpu, unsigned int mask)
{
...
void   get_sys_info  ( sys_info_t * );
static __inline ulong get_ddr_freq(ulong dummy)
{
...
/* lib/net_utils.c */
// #include <net.h>
// static __inline IPaddr_t getenv_IPaddr(char *var)
// {
...
static __inline void *map_sysmem(phys_addr_t paddr, unsigned long len)
{
	return (void *)(uintptr_t)paddr;
}

static __inline void unmap_sysmem(const void *vaddr)
{
}
# endif
